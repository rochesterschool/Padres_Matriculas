...
/**
 *  aprendoz_desarrollo.VistaTransporteListadoAlumnosId
 *  09/20/2012 08:52:53
 * 
 */
public class VistaTransporteListadoAlumnosId
    implements Serializable
{
    ...
    public VistaTransporteListadoAlumnosId() {
    }

    public VistaTransporteListadoAlumnosId(String codigo, String apellido1, String apellido2, String nombre1, String nombre2) {
        this.codigo = codigo;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VistaTransporteListadoAlumnosId)) {
            return false;
        }
        VistaTransporteListadoAlumnosId other = ((VistaTransporteListadoAlumnosId) o);
        if (this.codigo == null) {
