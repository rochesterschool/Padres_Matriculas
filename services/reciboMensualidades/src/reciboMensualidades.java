...
public class reciboMensualidades extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
     public DownloadResponse getReport(String idp) throws Exception {
       ...
       try {
          ...
          parameters.put("idpersona", idper);
          ...
          ret.setFileName("ReciboPresupuestoMensualidades_"+idp+".pdf");
