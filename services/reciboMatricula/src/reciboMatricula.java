...
public class reciboMatricula extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    public DownloadResponse getReport(String idp) throws Exception {
       ...
       try {
          ...
          parameters.put("idPersona", idper);//string??? no int?? intente con Integer pero no funciono
          //parameters.put("idasignatura", ida);
          //System.out.println("capturados!");
          
          //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("modeloContratoMatricula.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("modeloContratoMatricula.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          //ret.setFileName("Asignatura: ""Estudiante: "+cadenaEst+".pdf");
          ret.setFileName("modeloMatricula_"+idp+".pdf");
